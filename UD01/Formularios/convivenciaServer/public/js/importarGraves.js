...
$.getJSON("http://localhost:3000/convivenciaGrave", function (data) {
  ...
  $.each(data, function (key, val) {
    items.push("<tr><td> " + val.nombreAlumno + "<input type='submit' class='modificar' value='Modificar' onclick='modificarIncidencia(\"" + val._id + "\")' ><input class='eliminar' type='submit' value='Eliminar' onclick='deleteFalta(\"" + val._id + "\")'></td></tr>");
  });
